Public Class View_Barangay_News
    ...
    Private Sub lbl_barangay_news_body_MouseEnter(sender As Object, e As EventArgs) Handles lbl_barangay_news_body.MouseEnter
        lbl_barangay_news_body.Cursor = Cursors.Arrow
    End Sub
End Class